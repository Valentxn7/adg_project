...
public class ControllerExportPng implements EventHandler<ActionEvent> {
    private ModelUML modelUML;
    private Stage rootStage;

    public ControllerExportPng(ModelUML modelUML, Stage rootStage) {
    ...
    public void handle(ActionEvent event) {
        ...
        Export.exportPNG(this.modelUML.getVueDiagramme(), new File(path).getParent(), new File(path).getName());
    }
}
